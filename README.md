...
add .env.local file :-
NEXTAUTH_URL=xxxxxxxxxxxxxx...
NEXTAUTH_SECRET=xxxxxxxxxxx...
MONGODB_URI=xxxxxxxxxxx..


NEXT_PUBLIC_CASHFREE_APP_ID=xxxxxxxxxxxxxx..
NEXT_PUBLIC_CASHFREE_SECRET_KEY=xxxxxxxxxxxxxxx..
NEXT_PUBLIC_CASHFREE_MODE=xxxxx.
